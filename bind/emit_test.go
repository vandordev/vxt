...
func TestGenerateEmitsTypedWrapperPackageSurface(t *testing.T) {
	...
	if out.BindingName != "service" {
		t.Fatalf("got binding name %q", out.BindingName)
	}
	if out.PackageName != "servicevxt" {
		t.Fatalf("got package name %q", out.PackageName)
	}

	content := out.Files[0].Content
	assertContains(t, content, "// Code generated by vxt bind. DO NOT EDIT.")
	assertContains(t, content, "// VXT binding: service")
	assertContains(t, content, "// VXT package: servicevxt")
